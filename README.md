...
Scoop manifests for [HomeNVR](https://github.com/ric-dg/homenvr-v1) — a
...
[HomeNVR installer](https://github.com/ric-dg/homenvr-v1/releases) instead if you
...
Requires `gh` authenticated against `ric-dg/homenvr-v1`.
